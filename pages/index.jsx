                    ...
                    <div className={style.content}>
                        <div className={style.readme}>
                            ...
                            <div style={{ marginTop: 8, marginLeft: 12 }}>
                              ...
                              <button className='link' style={{ fontSize: '1.1rem' }} onClick={() => window.open('https://austinispog.tk/spotify')}><img src="/spotify-brands.svg" style={{ width: 5, height: 5 }} />NotMrAustin</button> <br />
